...
<span class="legend-item"><span class="badge badge-confirmed">实色</span> 已确认</span>
<span class="legend-item"><span class="badge badge-reported">描边</span> 有报道</span>
...
<div class="disclaimer">以下信息来自小红书，未经官方核实。Programme 课纲见 <a href="{MSC_CURRICULUM_URL}" target="_blank" rel="noopener">MSc CS 官网</a></div>
<h2>课程概况</h2>
...
<h1>关于本站</h1>
<h2>数据来源</h2>
<p>课程基本信息来自 <a href="https://www.cs.cityu.edu.hk/en/academic-programmes/msc-computer-science/curriculum/structures">CityU CS 官网</a>。评价信息来自小红书帖子及评论区，通过 <a href="https://github.com/jackwener/xiaohongshu-cli" target="_blank" rel="noopener">xiaohongshu-cli</a> 采集并整理。</p>
<h2>可信度说明</h2>
<ul>
<li><span class="badge badge-confirmed">已确认</span> — 2 篇及以上独立帖子说法一致，或帖子与评论区相互印证</li>
<li><span class="badge badge-reported">有报道</span> — 仅 1 篇来源提及，或同一帖子内重复提及</li>
